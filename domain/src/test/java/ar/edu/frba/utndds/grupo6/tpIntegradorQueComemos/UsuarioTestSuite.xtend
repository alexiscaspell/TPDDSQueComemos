...
class UsuarioTestSuite {
	...
	def void testEnunciado() {
		val persona_enunciado = new UsuarioPosta(83, 1.88, Rutina.ACTIVA_SIN_EJERCICIO, "Juan Jose Lopez", Sexo.
			MASCULINO, fecha)
	...
	def void usuarioDiabeticoSaludable() {
		val usuarioDiabeticoSaludable = new UsuarioPosta(82, 1.78, Rutina.ACTIVA_SIN_EJERCICIO, "Juan Jose Lopez",
	...
	def void usuarioDiabeticoNoSaludable() {
		val usuarioDiabeticoNoSaludable = new UsuarioPosta(82, 1.78, Rutina.LEVE, "Juan Jose Lopez", Sexo.MASCULINO,
			fecha)
	...
	def void usuarioDiabeticoGordo() {
		val usuarioDiabeticoGordo = new UsuarioPosta(100, 1.78, Rutina.INTENSIVO, "Juan Jose Lopez", Sexo.MASCULINO,
			fecha)
	...
	def void usuarioHipertensoSaludable() {
		val usuarioHipertensoSaludable = new UsuarioPosta(82, 1.78, Rutina.INTENSIVO, "Juan Jose Lopez", Sexo.MASCULINO,
			fecha)
	...
	def void usuarioHipertensoNoSaludable() {
		val usuarioHipertensoNoSaludable = new UsuarioPosta(82, 1.78, Rutina.LEVE, "Juan Jose Lopez", Sexo.MASCULINO,
			fecha)
	...
	def void usuarioHipertensoGordo() {
		val usuarioHipertensoGordo = new UsuarioPosta(100, 1.78, Rutina.ACTIVA_SIN_EJERCICIO, "Juan Jose Lopez",
			Sexo.MASCULINO, fecha)
	...
	private def Receta getReceta(Usuario usuario, String nombre) {
		...
		temporadas.add(Temporada.PRIMAVERA)
		temporadas.add(Temporada.VERANO)
		val receta = new Receta(usuario.nombre, nombre, ingredientes, condimentos, explicacion, Dificultad.FACIL,
			temporadas)
	...
	private def getUsuarioPancho() {
		val pancho = new UsuarioPosta(90.4, 1.90, Rutina.ACTIVA_SIN_EJERCICIO, "Francisco Jose Lopez", Sexo.MASCULINO,
			fecha)
		pancho
	}
}
