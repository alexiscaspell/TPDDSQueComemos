...
class FiltroStrategyTestSuite {
	...
	def void FiltroStrategyCarosYNoLeGusta() {
		...
		val listaFiltrada  = FiltroCarosYNoLeGusta.aplicarFiltro( usuario1.recetasConocidas, usuario1 )
		//println( "La cantidad de elementos en la lista filtrada = " + listaFiltrada.size )
	...
	def void FiltroStrategyNoLeGusta() {
		...
		val listaFiltrada  = FiltroNoLeGusta.aplicarFiltro( usuario1.recetasConocidas, usuario1 )
		//println( "La cantidad de elementos en la lista filtrada = " + listaFiltrada.size )
	...
	def void FiltroStrategySinFiltro() {
		...
		val listaFiltrada  = SinFiltro.aplicarFiltro( usuario1.recetasConocidas, usuario1 )
		//println( "La cantidad de elementos en la lista filtrada = " + listaFiltrada.size )
